...
<div class="top_view">
    <div class="banner">
        <img style="width:100%;" src="images/top/banner.png">
    </div>
    <div class="content_list">
        <div class="listitem">
            <div class="content_background">
                ...
                <div class="subtitle">
                    <p>ABOUT</p>
                    <img style="width:83px;margin:25px 0;" src="images/top/line.png">
                </div>
        ...
        <div class="listitem">
            ...
            <div class="top_content">
                <img class="picture" src="images/top/littleicon.png">
        ...
        <div class="listitem">
            ...
            <div class="top_content">
                <img class="picture" src="images/top/bigicon.png">
                <div class="discribe">
                    <p>参选入围</p>
                    <p>用户投票</p>
                    <p>结果公示</p>
    ...
    <div class="footer">
        ...
        <div class="footer_pic">
            <img src="images/top/partner.png">
        </div>
    </div>
</div>
