    ...
    $(function () {
        ...
        layui.use(['form', 'table', 'layer'], function () {
            ...
            table.render({
                elem: '#demo',
                id: 'tableReload'
                , url: 'storehouse/list' //数据接口
                , page: true //开启分页
                , cols: [[
                    {checkbox: true, fixed: true, width: '5%'},//表头
                    {field: 'id', title: 'ID', width: '10%', sort: true, fixed: 'left'},
                    {field: 'admin', title: '管理员ID', width: '10%'},
                    {field: 'address', title: '仓库地址', width: '10%'},
                    {
                        field: 'createtime',
                        title: '创建时间',
                        width: '20%',
...
//                                        name: name
                                        ...
                                        , url: 'storehouse/list'//后台做模糊搜索接口路径
                                        , method: 'get'
                                    });
                    ...
                    var editTypeModel = layer.open({
                        ...
                        '                <input type="text" name="address" required="" value=' + data.address + ' lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">\n' +
                        ...
                        '            <div class="layui-input-block">\n' +
                        '                <input type="text" name="admin" required="" value=' + data.admin + ' lay-verify="required" placeholder="请输入管理员编号" autocomplete="off" class="layui-input">\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        '        <div class="layui-form-item">\n' +
                        '            <div class="layui-input-block">\n' +
...
//                                        name: name
            ...
            $("#addBtn").on('click', function () {
                ...
                var addTypeModel = layer.open({
                    ...
                    '            <label class="layui-form-label">仓库地址</label>\n' +
                    '            <div class="layui-input-block">\n' +
                    '                <input type="text" name="address" required="" lay-verify="required" placeholder="请输入仓库地址" autocomplete="off" class="layui-input">\n' +
                    '            </div>\n' +
                    '        </div>\n' +
                    '        <div class="layui-form-item">\n' +
                    '            <label class="layui-form-label">管理员编号</label>\n' +
                    '            <div class="layui-input-block">\n' +
                    '                <input type="text" name="admin" required="" lay-verify="required" placeholder="请输入管理员编号" autocomplete="off" class="layui-input">\n' +
                    '            </div>\n' +
                    '        </div>\n' +
                    '        <div class="layui-form-item">\n' +
                    '            <div class="layui-input-block">\n' +
