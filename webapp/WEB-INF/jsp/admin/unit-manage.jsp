        ...
        layui.use(['form', 'table', 'layer'], function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    {field: 'name', title: '单位名称', width: '10%'},
                    {
                        field: 'createtime',
                        title: '创建时间',
                        width: '25%',
...
//                                        name: name
                    ...
                    var editTypeModel = layer.open({
                        ...
                        '                <input type="text" name="name" required="" lay-verify="required" placeholder="请输入单位名称" autocomplete="off" class="layui-input">\n' +
