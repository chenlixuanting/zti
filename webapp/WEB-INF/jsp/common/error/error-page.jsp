...
<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="../../administrator/index.jsp">Vali</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li><a class="dropdown-item" href="../../administrator/page-login.jsp"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
            </ul>
        </li>
    </ul>
</header>
...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        <li><a class="app-menu__item" href="../../administrator/index.jsp"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Pages</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="../../administrator/page-login.jsp"><i class="icon fa fa-circle-o"></i> Login Page</a></li>
